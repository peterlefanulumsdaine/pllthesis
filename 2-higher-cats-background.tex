...
\begin{definition}\footnote{Strict $\omega$-categories may alternatively, and completely equivalently, be defined via iterated enrichment.}
...
This is made precise by Mark Weber in \cite{weber:operads-within}: $\MonGlobCat$ is (2-equivalent to) the 2-category of normalised pseudo-algebras for the ``internal strict $\omega$-category in $\Cat$'' 2-monad $\Tcal$ on $[\G^\op,\Cat]$.  \todo{[diagram cosmetics: vdots placement]}
