...
\item Think about: ``elim-structures'' for types with multiple intro forms, compared to familial representability as thinking of it for categorads?

\item The idea that ``all induction is structural induction''.  How does $\pi \mapsto \pi^-$ look when translated thru into these terms?
\end{document}