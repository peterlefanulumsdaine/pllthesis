...
\begin{theorem}Let $\T \in \DTT_\Id$ be any type theory with identity types, $A$ a closed type of $\T$.  Then the globular context $\A$ carries the structure of an internal $P_\Id$-algebra in $\T$.
\end{theorem}
